...
// in article_app/test/fetures/articles/helpers/article_test_helper.dart.
...
import 'package:article_app/features/articles/domain/repository/article_repository.dart'
    as _i3;
import 'package:article_app/features/core/resources/data_state.dart' as _i2;
...
class MockArticleRepository extends _i1.Mock implements _i3.ArticleRepository {
  ...
  @override
  _i4.Future<_i2.DataState<List<_i5.ArticleEntity>>> getMostViewedArticles(
          String? period) =>
      (super.noSuchMethod(
        Invocation.method(
